...
void run(){
  ...
  //  for Jet dataset
    ...
    P1D.PlotData("deltar_jet",       "SV deltaR jet (#PV:1-3)",        1, 0, 1);
    P1D.PlotData("deltar_sum_jet",     "SV deltaR sum jet (#PV:1-3)",  1, 0, 1);
    P1D.PlotData("deltar_sum_dir",     "SV deltaR sum dir (#PV:1-3)",  1, 0, 1);
    P1D.PlotData("vtxpt",              "SV vtx pt (#PV:1-3)",          1, 1, 1);
    P1D.PlotData("discri_tche",       "TCHE discriminator (#PV:1-3)",  1, 1, 1);
    P1D.PlotData("discri_tchp",       "TCHP discriminator (#PV:1-3)",  1, 1, 1);
    P1D.PlotData("discri_jetprob",    "JP discriminator (#PV:1-3)",    1, 1, 1);
    P1D.PlotData("discri_jetbprob",   "JBP discriminator (#PV:1-3)",   1, 1, 1);
    P1D.PlotData("discri_ssche0",    "SSVHE Discriminator (#PV:1-3)",  1, 1, 1);
    P1D.PlotData("discri_ssche",     "SSVHE Discriminator (#PV:1-3)",  1, 0, 0);
    P1D.PlotData("discri_sschp0",   "SSVHP Discriminator (#PV:1-3)",   1, 1, 1);
    P1D.PlotData("discri_sschp",    "SSVHP Discriminator (#PV:1-3)",   1, 0, 0);
    P1D.PlotData("muon_Pt",         "Muon p_{T} (#PV:1-3)",            1, 1, 1);
    P1D.PlotData("muon_ptrel",      "Muon p_{T}^{rel} (#PV:1-3)",      1, 0, 1);
    P1D.PlotData("muon_DeltaR",     "Muon deltaR (#PV:1-3)",           1, 0, 1);
    ...
    P1D.PlotStack("npv1_IP3d2sig0",        "2nd sorted track 3D IP significance (#PV:1-3)",   1, 1, 1);  
    P1D.PlotStack(  "npv1_IP3d3sig0",        "3rd sorted track 3D IP significance (#PV:1-3)", 1, 1, 1);  
    // P1D.PlotStack( "npv1_ntracks_jet",      "nr. of tracks in jet (#PV:1-3)",                   1, 1, 1);  
    //  P1D.PlotStack( "npv1_nseltracks_jet",   "nr. of sel tracks in jet (#PV:1-3)",               1, 1, 1);  
    P1D.PlotStack( "npv1_ncutseltracks_jet","nr. of tracks in jet (#PV:1-3)",           1, 1, 1);  
    P1D.PlotStack( "npv1_pt_tracks",        "Pt of tracks (#PV:1-3)",                         1, 1, 1);  
    P1D.PlotStack( "npv1_pt_seltracks",     "Pt of  sel tracks (#PV:1-3)",                    1, 1, 1);  
    P1D.PlotStack( "npv1_pt_cutseltracks",  "Pt of  cut sel tracks (#PV:1-3)",                1, 1, 1);  
    P1D.PlotStack( "npv1_nsv0",             "# of secondary vertices (#PV:1-3)",              1, 1, 1);  
    P1D.PlotStack( "npv1_nsv",              "# of secondary vertices (#PV:1-3)",              1, 1, 1);  
    P1D.PlotStack( "npv1_flightsig3d",      "Flight Significance 3D (#PV:1-3)",               1, 1, 1);  
    P1D.PlotStack( "npv1_flightsig3d_3tr",  "Flight Significance 3D for >=3tracks (#PV:1-3)", 1, 1, 1);  
    P1D.PlotStack( "npv1_svmass",           "SV mass (#PV:1-3)",                              1, 0, 1);  
    P1D.PlotStack( "npv1_svmass_3tr",       "SV mass for >=3tracks (#PV:1-3)",                1, 0, 1);  
    P1D.PlotStack( "npv1_nsv0_3tr",         "# of secondary vertices (>=3tr) (#PV:1-3)",      1, 1, 1);
    P1D.PlotStack("npv1_sveratio",        "SV eratio (#PV:1-3)",                  1, 0, 0);
    P1D.PlotStack("npv1_deltar_jet",      "SV deltaR jet (#PV:1-3)",              1, 0, 1);
    P1D.PlotStack("npv1_deltar_sum_jet",      "SV deltaR sum jet (#PV:1-3)",      1, 0, 1);
    P1D.PlotStack("npv1_deltar_sum_dir",      "SV deltaR sum dir (#PV:1-3)",      1, 0, 1);
    P1D.PlotStack("npv1_vtxpt",      "SV vtx pt (#PV:1-3)",                       1, 1, 1);
    P1D.PlotStack("npv1_discri_tche",      "TCHE discriminator (#PV:1-3)",        1, 1, 1);
    P1D.PlotStack("npv1_discri_tchp",      "TCHP discriminator (#PV:1-3)",        1, 1, 1);
    P1D.PlotStack("npv1_discri_jetprob",      "JP discriminator (#PV:1-3)",       1, 1, 1);
    P1D.PlotStack("npv1_discri_jetbprob",      "JBP discriminator (#PV:1-3)",     1, 1, 1);
    P1D.PlotStack("npv1_discri_ssche0",       "SSVHE Discriminator (#PV:1-3)",    1, 1, 1);
    P1D.PlotStack("npv1_discri_ssche",   "SSVHE Discriminator (#PV:1-3)",         1, 0, 0);
    P1D.PlotStack("npv1_discri_sschp0",   "SSVHP Discriminator (#PV:1-3)",        1, 1, 1);
    P1D.PlotStack("npv1_discri_sschp",   "SSVHP Discriminator (#PV:1-3)",         1, 0, 0);
    P1D.PlotStack("npv1_muon_Pt",        "Muon p_{T} (#PV:1-3)",                  1, 1, 1);
    P1D.PlotStack("npv1_muon_ptrel",    "Muon p_{T}^{rel} (#PV:1-3)",             1, 0, 1);
    P1D.PlotStack("npv1_muon_DeltaR",         "Muon1 deltaR (#PV:1-3)",           1, 0, 1);


    P1D.PlotStack("npv2_IP3d2sig0",        "2nd sorted track 3D IP significance (#PV:3-7)",   1, 1, 1);  
    P1D.PlotStack(  "npv2_IP3d3sig0",        "3rd sorted track 3D IP significance (#PV:3-7)", 1, 1, 1);  
    // P1D.PlotStack( "npv2_ntracks_jet",      "nr. of tracks in jet (#PV:3-7)",                   1, 1, 1);  
    //  P1D.PlotStack( "npv2_nseltracks_jet",   "nr. of sel tracks in jet (#PV:3-7)",               1, 1, 1);  
    P1D.PlotStack( "npv2_ncutseltracks_jet","nr. of tracks in jet (#PV:3-7)",           1, 1, 1);  
    P1D.PlotStack( "npv2_pt_tracks",        "Pt of tracks (#PV:3-7)",                         1, 1, 1);  
    P1D.PlotStack( "npv2_pt_seltracks",     "Pt of  sel tracks (#PV:3-7)",                    1, 1, 1);  
    P1D.PlotStack( "npv2_pt_cutseltracks",  "Pt of  cut sel tracks (#PV:3-7)",                1, 1, 1);  
    P1D.PlotStack( "npv2_nsv0",             "# of secondary vertices (#PV:3-7)",              1, 1, 1);  
    P1D.PlotStack( "npv2_nsv",              "# of secondary vertices (#PV:3-7)",              1, 1, 1);  
    P1D.PlotStack( "npv2_flightsig3d",      "Flight Significance 3D (#PV:3-7)",               1, 1, 1);  
    P1D.PlotStack( "npv2_flightsig3d_3tr",  "Flight Significance 3D for >=3tracks (#PV:3-7)", 1, 1, 1);  
    P1D.PlotStack( "npv2_svmass",           "SV mass (#PV:3-7)",                              1, 0, 1);  
    P1D.PlotStack( "npv2_svmass_3tr",       "SV mass for >=3tracks (#PV:3-7)",                1, 0, 1);  
    P1D.PlotStack( "npv2_nsv0_3tr",         "# of secondary vertices (>=3tr) (#PV:3-7)",      1, 1, 1);
 
    P1D.PlotStack("npv2_sveratio",        "SV eratio (#PV:3-7)",                  1, 0, 0);
    P1D.PlotStack("npv2_deltar_jet",      "SV deltaR jet (#PV:3-7)",              1, 0, 1);
    P1D.PlotStack("npv2_deltar_sum_jet",      "SV deltaR sum jet (#PV:3-7)",      1, 0, 1);
    P1D.PlotStack("npv2_deltar_sum_dir",      "SV deltaR sum dir (#PV:3-7)",      1, 0, 1);
    P1D.PlotStack("npv2_vtxpt",      "SV vtx pt (#PV:3-7)",                       1, 1, 1);
    P1D.PlotStack("npv2_discri_tche",      "TCHE discriminator (#PV:3-7)",        1, 1, 1);
    P1D.PlotStack("npv2_discri_tchp",      "TCHP discriminator (#PV:3-7)",        1, 1, 1);
    P1D.PlotStack("npv2_discri_jetprob",      "JP discriminator (#PV:3-7)",       1, 1, 1);
    P1D.PlotStack("npv2_discri_jetbprob",      "JBP discriminator (#PV:3-7)",     1, 1, 1);
    P1D.PlotStack("npv2_discri_ssche0",       "SSVHE Discriminator (#PV:3-7)",    1, 1, 1);
    P1D.PlotStack("npv2_discri_ssche",   "SSVHE Discriminator (#PV:3-7)",         1, 0, 0);
    P1D.PlotStack("npv2_discri_sschp0",   "SSVHP Discriminator (#PV:3-7)",        1, 1, 1);
    P1D.PlotStack("npv2_discri_sschp",   "SSVHP Discriminator (#PV:3-7)",         1, 0, 0);
    P1D.PlotStack("npv2_muon_Pt",        "Muon p_{T} (#PV:3-7)",                  1, 1, 1);
    P1D.PlotStack("npv2_muon_ptrel",    "Muon p_{T}^{rel} (#PV:3-7)",             1, 0, 1);
    P1D.PlotStack("npv2_muon_DeltaR",         "Muon1 deltaR (#PV:3-7)",           1, 0, 1);


    P1D.PlotStack("npv3_IP3d2sig0",        "2nd sorted track 3D IP significance (#PV:>7)",   1, 1, 1);  
    P1D.PlotStack(  "npv3_IP3d3sig0",        "3rd sorted track 3D IP significance (#PV:>7)", 1, 1, 1);  
    // P1D.PlotStack( "npv3_ntracks_jet",      "nr. of tracks in jet (#PV:>7)",                   1, 1, 1);  
    //  P1D.PlotStack( "npv3_nseltracks_jet",   "nr. of sel tracks in jet (#PV:>7)",               1, 1, 1);  
    P1D.PlotStack( "npv3_ncutseltracks_jet","nr. of tracks in jet (#PV:>7)",           1, 1, 1);  
    P1D.PlotStack( "npv3_pt_tracks",        "Pt of tracks (#PV:>7)",                         1, 1, 1);  
    P1D.PlotStack( "npv3_pt_seltracks",     "Pt of  sel tracks (#PV:>7)",                    1, 1, 1);  
    P1D.PlotStack( "npv3_pt_cutseltracks",  "Pt of  cut sel tracks (#PV:>7)",                1, 1, 1);  
    P1D.PlotStack( "npv3_nsv0",             "# of secondary vertices (#PV:>7)",              1, 1, 1);  
    P1D.PlotStack( "npv3_nsv",              "# of secondary vertices (#PV:>7)",              1, 1, 1);  
    P1D.PlotStack( "npv3_flightsig3d",      "Flight Significance 3D (#PV:>7)",               1, 1, 1);  
    P1D.PlotStack( "npv3_flightsig3d_3tr",  "Flight Significance 3D for >=3tracks (#PV:>7)", 1, 1, 1);  
    P1D.PlotStack( "npv3_svmass",           "SV mass (#PV:>7)",                              1, 0, 1);  
    P1D.PlotStack( "npv3_svmass_3tr",       "SV mass for >=3tracks (#PV:>7)",                1, 0, 1);  
    P1D.PlotStack( "npv3_nsv0_3tr",         "# of secondary vertices (>=3tr) (#PV:>7)",      1, 1, 1);
 
    P1D.PlotStack("npv3_sveratio",        "SV eratio (#PV:>7)",                  1, 0, 0);
    P1D.PlotStack("npv3_deltar_jet",      "SV deltaR jet (#PV:>7)",              1, 0, 1);
    P1D.PlotStack("npv3_deltar_sum_jet",      "SV deltaR sum jet (#PV:>7)",      1, 0, 1);
    P1D.PlotStack("npv3_deltar_sum_dir",      "SV deltaR sum dir (#PV:>7)",      1, 0, 1);
    P1D.PlotStack("npv3_vtxpt",      "SV vtx pt (#PV:>7)",                       1, 1, 1);
    P1D.PlotStack("npv3_discri_tche",      "TCHE discriminator (#PV:>7)",        1, 1, 1);
    P1D.PlotStack("npv3_discri_tchp",      "TCHP discriminator (#PV:>7)",        1, 1, 1);
    P1D.PlotStack("npv3_discri_jetprob",      "JP discriminator (#PV:>7)",       1, 1, 1);
    P1D.PlotStack("npv3_discri_jetbprob",      "JBP discriminator (#PV:>7)",     1, 1, 1);
    P1D.PlotStack("npv3_discri_ssche0",       "SSVHE Discriminator (#PV:>7)",    1, 1, 1);
    P1D.PlotStack("npv3_discri_ssche",   "SSVHE Discriminator (#PV:>7)",         1, 0, 0);
    P1D.PlotStack("npv3_discri_sschp0",   "SSVHP Discriminator (#PV:>7)",        1, 1, 1);
    P1D.PlotStack("npv3_discri_sschp",   "SSVHP Discriminator (#PV:>7)",         1, 0, 0);
    P1D.PlotStack("npv3_muon_Pt",        "Muon p_{T} (#PV:>7)",                  1, 1, 1);
    P1D.PlotStack("npv3_muon_ptrel",    "Muon p_{T}^{rel} (#PV:>7)",             1, 0, 1);
    P1D.PlotStack("npv3_muon_DeltaR",         "Muon1 deltaR (#PV:>7)",           1, 0, 1);
