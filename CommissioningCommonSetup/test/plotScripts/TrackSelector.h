...
public :
  ...
  // some objects
   ...
   virtual void    SetUp(bool isData_, TH1D*dataHist_, TH1D* mcHistb_,TH1D* mcHistbglusplit_, TH1D* mcHistc_, TH1D* mcHistl_, TH1D* mcHistn_, informationTrackCuts info_){
     isData = isData_;
     dataHist = dataHist_;
