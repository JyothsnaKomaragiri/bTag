...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("file:~/MetaData/Test_QCD_Pt_170to300RECO.root")
)
########### Event cleaning ###########
...
process.standardPFBTagNtuple.getMCTruth = cms.bool(True)
process.standardPFBTagNtuple.getSimTruth = cms.bool(True)
...
process.standardPFBTagNtuple.TrackMCTruthMatchChi2Cut = cms.double(25.0)
